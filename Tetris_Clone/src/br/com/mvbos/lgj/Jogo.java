...
public class Jogo extends JFrame {
	...
	public enum Tecla {
		CIMA, BAIXO, ESQUERDA, DIREITA, BA, BB, BC, BD, GI
	}
	...
	private void setaTecla(int tecla, boolean pressionada) {
		switch (tecla) {
			...
			case KeyEvent.VK_S:
				controleTecla[Tecla.BD.ordinal()] = pressionada;
				break;
			case KeyEvent.VK_SHIFT:
				controleTecla[Tecla.GI.ordinal()] = pressionada;
				break;
			...
			if (System.currentTimeMillis() >= prxAtualizacao) {
				...
				if (controleTecla[Tecla.BA.ordinal()]) {
					...
					if (cenario instanceof InicioCenario) {
						...
						g2d.drawString("Carregando...", 180, 300);
						tela.repaint();
				...
				if (cenario == null) {
					g2d.setColor(Color.WHITE);
					g2d.drawString("O Cenario e uma ilusao...", 20, 20);
					...
					if (Jogo.pausado) {
						g2d.setColor(Color.WHITE);
						g2d.drawString("Pausado", tela.getWidth() / 2 - 40, tela.getHeight() / 2);
					}
				}
